...
tags: [mitre-attack, sub-technique, T0843.003]
---

# T0843.003 - Program Append (sub-technique of T0843)

**Tactic(s):** Lateral Movement  -  **Platforms:** n/a  -  **ATT&CK:** [T0843.003](https://attack.mitre.org/techniques/T0843/003)
...
Used to achieve the **Lateral Movement** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: any.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T0843/003
