...
tags: [mitre-attack, sub-technique, T1027.011]
---

# T1027.011 - Fileless Storage (sub-technique of T1027)

**Tactic(s):** Stealth  ·  **Platforms:** Linux, Windows  ·  **ATT&CK:** [T1027.011](https://attack.mitre.org/techniques/T1027/011)
...
Used to achieve the **Stealth** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Linux, Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1027/011
