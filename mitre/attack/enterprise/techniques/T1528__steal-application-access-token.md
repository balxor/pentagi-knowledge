...
tags: [mitre-attack, technique, T1528]
---
...
Used to achieve the **Credential Access** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Containers, IaaS, Identity Provider, Office Suite, SaaS.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1528
