...
tags: [mitre-attack, technique, T1677]
---
...
Used to achieve the **Execution** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: SaaS.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1677
