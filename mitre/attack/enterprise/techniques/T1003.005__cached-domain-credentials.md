...
tags: [mitre-attack, sub-technique, T1003.005]
---

# T1003.005 - Cached Domain Credentials (sub-technique of T1003)

**Tactic(s):** Credential Access  -  **Platforms:** Windows, Linux  -  **ATT&CK:** [T1003.005](https://attack.mitre.org/techniques/T1003/005)
...
Used to achieve the **Credential Access** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Windows, Linux.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1003/005
