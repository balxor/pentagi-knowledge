...
tags: [mitre-attack, sub-technique, T1098.001]
---

# T1098.001 - Additional Cloud Credentials (sub-technique of T1098)

**Tactic(s):** Persistence, Privilege Escalation  ·  **Platforms:** IaaS, Identity Provider, SaaS  ·  **ATT&CK:** [T1098.001](https://attack.mitre.org/techniques/T1098/001)
...
Used to achieve the **Persistence, Privilege Escalation** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: IaaS, Identity Provider, SaaS.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1098/001
