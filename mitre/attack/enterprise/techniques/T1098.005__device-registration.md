...
tags: [mitre-attack, sub-technique, T1098.005]
---

# T1098.005 - Device Registration (sub-technique of T1098)

**Tactic(s):** Persistence, Privilege Escalation  ·  **Platforms:** Windows, Identity Provider  ·  **ATT&CK:** [T1098.005](https://attack.mitre.org/techniques/T1098/005)
...
Used to achieve the **Persistence, Privilege Escalation** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Windows, Identity Provider.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1098/005
