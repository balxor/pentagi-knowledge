...
tags: [mitre-attack, technique, T1112]
---
...
Used to achieve the **Defense Impairment, Persistence** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1112
