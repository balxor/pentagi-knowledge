...
tags: [mitre-attack, sub-technique, T1566.004]
---

# T1566.004 - Spearphishing Voice (sub-technique of T1566)

**Tactic(s):** Initial Access  -  **Platforms:** Linux, macOS, Windows, Identity Provider  -  **ATT&CK:** [T1566.004](https://attack.mitre.org/techniques/T1566/004)
...
Used to achieve the **Initial Access** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Linux, macOS, Windows, Identity Provider.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1566/004
