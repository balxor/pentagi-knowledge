...
tags: [mitre-attack, sub-technique, T1137.001]
---

# T1137.001 - Office Template Macros (sub-technique of T1137)

**Tactic(s):** Persistence  -  **Platforms:** Office Suite, Windows  -  **ATT&CK:** [T1137.001](https://attack.mitre.org/techniques/T1137/001)
...
Used to achieve the **Persistence** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Office Suite, Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1137/001
