...
tags: [mitre-attack, technique, T1082]
---
...
Used to achieve the **Discovery** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: ESXi, IaaS, Linux, macOS, Network Devices, Windows.

Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1082
