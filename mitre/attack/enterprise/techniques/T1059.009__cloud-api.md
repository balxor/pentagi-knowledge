...
tags: [mitre-attack, sub-technique, T1059.009]
---

# T1059.009 - Cloud API (sub-technique of T1059)

**Tactic(s):** Execution  ·  **Platforms:** IaaS, Identity Provider, Office Suite, SaaS  ·  **ATT&CK:** [T1059.009](https://attack.mitre.org/techniques/T1059/009)
...
Used to achieve the **Execution** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: IaaS, Identity Provider, Office Suite, SaaS.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1059/009
