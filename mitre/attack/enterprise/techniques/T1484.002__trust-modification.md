...
tags: [mitre-attack, sub-technique, T1484.002]
---

# T1484.002 - Trust Modification (sub-technique of T1484)

**Tactic(s):** Defense Impairment, Privilege Escalation  ·  **Platforms:** Identity Provider, Windows  ·  **ATT&CK:** [T1484.002](https://attack.mitre.org/techniques/T1484/002)
...
Used to achieve the **Defense Impairment, Privilege Escalation** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Identity Provider, Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1484/002
