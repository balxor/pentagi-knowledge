...
tags: [mitre-attack, sub-technique, T1480.001]
---

# T1480.001 - Environmental Keying (sub-technique of T1480)

**Tactic(s):** Stealth  ·  **Platforms:** Linux, Windows, macOS  ·  **ATT&CK:** [T1480.001](https://attack.mitre.org/techniques/T1480/001)
...
Used to achieve the **Stealth** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Linux, Windows, macOS.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1480/001
