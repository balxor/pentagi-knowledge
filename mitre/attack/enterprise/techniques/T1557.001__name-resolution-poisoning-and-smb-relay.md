...
tags: [mitre-attack, sub-technique, T1557.001]
---

# T1557.001 - Name Resolution Poisoning and SMB Relay (sub-technique of T1557)

**Tactic(s):** Credential Access, Collection  ·  **Platforms:** Windows  ·  **ATT&CK:** [T1557.001](https://attack.mitre.org/techniques/T1557/001)
...
Used to achieve the **Credential Access, Collection** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1557/001
