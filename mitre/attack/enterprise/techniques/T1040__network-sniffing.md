...
tags: [mitre-attack, technique, T1040]
---
...
Used to achieve the **Credential Access, Discovery** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: IaaS, Linux, macOS, Network Devices, Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1040
