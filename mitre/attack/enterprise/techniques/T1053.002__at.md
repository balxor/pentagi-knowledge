...
tags: [mitre-attack, sub-technique, T1053.002]
---

# T1053.002 - At (sub-technique of T1053)

**Tactic(s):** Execution, Persistence, Privilege Escalation  ·  **Platforms:** Windows, Linux, macOS  ·  **ATT&CK:** [T1053.002](https://attack.mitre.org/techniques/T1053/002)
...
Used to achieve the **Execution, Persistence, Privilege Escalation** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Windows, Linux, macOS.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1053/002
