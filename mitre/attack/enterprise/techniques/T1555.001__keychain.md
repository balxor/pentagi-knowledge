...
tags: [mitre-attack, sub-technique, T1555.001]
---

# T1555.001 - Keychain (sub-technique of T1555)

**Tactic(s):** Credential Access  -  **Platforms:** macOS  -  **ATT&CK:** [T1555.001](https://attack.mitre.org/techniques/T1555/001)
...
Used to achieve the **Credential Access** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: macOS.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1555/001
