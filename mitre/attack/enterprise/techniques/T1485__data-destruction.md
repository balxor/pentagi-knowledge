...
tags: [mitre-attack, technique, T1485]
---

# T1485 - Data Destruction

**Tactic(s):** Impact  -  **Platforms:** Containers, ESXi, IaaS, Linux, macOS, Windows  -  **ATT&CK:** [T1485](https://attack.mitre.org/techniques/T1485)
...
Used to achieve the **Impact** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Containers, ESXi, IaaS, Linux, macOS, Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1485
