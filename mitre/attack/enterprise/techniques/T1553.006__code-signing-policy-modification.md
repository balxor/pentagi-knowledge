...
tags: [mitre-attack, sub-technique, T1553.006]
---

# T1553.006 - Code Signing Policy Modification (sub-technique of T1553)

**Tactic(s):** Defense Impairment  ·  **Platforms:** macOS, Windows  ·  **ATT&CK:** [T1553.006](https://attack.mitre.org/techniques/T1553/006)
...
Used to achieve the **Defense Impairment** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: macOS, Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1553/006
