...
tags: [mitre-attack, sub-technique, T1574.006]
---

# T1574.006 - Dynamic Linker Hijacking (sub-technique of T1574)

**Tactic(s):** Stealth, Execution  -  **Platforms:** Linux, macOS  -  **ATT&CK:** [T1574.006](https://attack.mitre.org/techniques/T1574/006)
...
Used to achieve the **Stealth, Execution** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Linux, macOS.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1574/006
