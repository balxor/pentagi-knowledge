...
tags: [mitre-attack, technique, T1606]
---
...
Used to achieve the **Credential Access** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: SaaS, Windows, macOS, Linux, IaaS, Office Suite, Identity Provider.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1606
