...
tags: [mitre-attack, sub-technique, T1548.002]
---

# T1548.002 - Bypass User Account Control (sub-technique of T1548)

**Tactic(s):** Privilege Escalation  ·  **Platforms:** Windows  ·  **ATT&CK:** [T1548.002](https://attack.mitre.org/techniques/T1548/002)
...
Used to achieve the **Privilege Escalation** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1548/002
