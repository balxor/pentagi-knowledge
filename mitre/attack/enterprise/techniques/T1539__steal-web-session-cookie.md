...
tags: [mitre-attack, technique, T1539]
---
...
Used to achieve the **Credential Access** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Linux, macOS, Office Suite, SaaS, Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1539
