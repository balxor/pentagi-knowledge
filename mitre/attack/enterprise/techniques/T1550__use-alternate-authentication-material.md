...
tags: [mitre-attack, technique, T1550]
---
...
Used to achieve the **Lateral Movement** objective. An autonomous agent invokes this when its current sub-goal matches that tactic and the target platform is one of: Containers, IaaS, Identity Provider, Linux, Office Suite, SaaS, Windows.
...
Source: MITRE ATT&CK - https://attack.mitre.org/techniques/T1550
