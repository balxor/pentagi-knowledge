...
tags: [mitre-cwe, weakness, CWE-160]
---

# CWE-160 - Improper Neutralization of Leading Special Elements

**Abstraction:** Variant  -  **Status:** Incomplete  -  **CWE:** [CWE-160](https://cwe.mitre.org/data/definitions/160.html)
...
- **general**: Developers should anticipate that leading special elements will be injected/removed/manipulated in the input vectors of their product. Use an appropriate combination of denylists and allowlists to ensure only valid, expected and appropriate input is processed by the system.
...
Source: MITRE CWE - https://cwe.mitre.org/data/definitions/160.html
