...
tags: [mitre-cwe, weakness, CWE-155]
---

# CWE-155 - Improper Neutralization of Wildcards or Matching Symbols

**Abstraction:** Variant  -  **Status:** Draft  -  **CWE:** [CWE-155](https://cwe.mitre.org/data/definitions/155.html)
...
- **general**: Developers should anticipate that wildcard or matching elements will be injected/removed/manipulated in the input vectors of their product. Use an appropriate combination of denylists and allowlists to ensure only valid, expected and appropriate input is processed by the system.
...
Source: MITRE CWE - https://cwe.mitre.org/data/definitions/155.html
