...
abstraction: Variant
status: Draft
languages: [PHP, Web Based, Web Server]
related_capec: [CAPEC-193]
url: https://cwe.mitre.org/data/definitions/98.html
tags: [mitre-cwe, weakness, CWE-98]
---

# CWE-98 - Improper Control of Filename for Include/Require Statement in PHP Program ('PHP Remote File Inclusion')

**Abstraction:** Variant  -  **Status:** Draft  -  **CWE:** [CWE-98](https://cwe.mitre.org/data/definitions/98.html)
...
- **Operation, Implementation**: Develop and run your code in the most recent versions of PHP available, preferably PHP 6 or later. Many of the highly risky features in earlier PHP interpreters have been removed, restricted, or disabled by default.
...
- **Operation**: Set allow_url_fopen to false, which limits the ability to include files from remote locations.
...
Source: MITRE CWE - https://cwe.mitre.org/data/definitions/98.html
