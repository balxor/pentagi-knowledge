...
tags: [mitre-cwe, weakness, CWE-163]
---

# CWE-163 - Improper Neutralization of Multiple Trailing Special Elements

**Abstraction:** Variant  -  **Status:** Incomplete  -  **CWE:** [CWE-163](https://cwe.mitre.org/data/definitions/163.html)
...
- **general**: Developers should anticipate that multiple trailing special elements will be injected/removed/manipulated in the input vectors of their product. Use an appropriate combination of denylists and allowlists to ensure only valid, expected and appropriate input is processed by the system.
...
Source: MITRE CWE - https://cwe.mitre.org/data/definitions/163.html
