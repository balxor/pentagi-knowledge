...
tags: [mitre-cwe, weakness, CWE-164]
---

# CWE-164 - Improper Neutralization of Internal Special Elements

**Abstraction:** Variant  -  **Status:** Incomplete  -  **CWE:** [CWE-164](https://cwe.mitre.org/data/definitions/164.html)
...
- **general**: Developers should anticipate that internal special elements will be injected/removed/manipulated in the input vectors of their product. Use an appropriate combination of denylists and allowlists to ensure only valid, expected and appropriate input is processed by the system.
...
Source: MITRE CWE - https://cwe.mitre.org/data/definitions/164.html
