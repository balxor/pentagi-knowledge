...
tags: [mitre-cwe, weakness, CWE-144]
---

# CWE-144 - Improper Neutralization of Line Delimiters

**Abstraction:** Variant  -  **Status:** Draft  -  **CWE:** [CWE-144](https://cwe.mitre.org/data/definitions/144.html)
...
- **general**: Developers should anticipate that line delimiters will be injected/removed/manipulated in the input vectors of their product. Use an appropriate combination of denylists and allowlists to ensure only valid, expected and appropriate input is processed by the system.
...
Source: MITRE CWE - https://cwe.mitre.org/data/definitions/144.html
