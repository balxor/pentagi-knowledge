...
tags: [mitre-cwe, weakness, CWE-151]
---

# CWE-151 - Improper Neutralization of Comment Delimiters

**Abstraction:** Variant  -  **Status:** Draft  -  **CWE:** [CWE-151](https://cwe.mitre.org/data/definitions/151.html)
...
- **general**: Developers should anticipate that comments will be injected/removed/manipulated in the input vectors of their product. Use an appropriate combination of denylists and allowlists to ensure only valid, expected and appropriate input is processed by the system.
...
Source: MITRE CWE - https://cwe.mitre.org/data/definitions/151.html
